      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {blogs.map((blog) => (
              <Link key={blog._id} to={`/blog/${blog._id}`} className="flex flex-col rounded-3xl shadow-lg hover:shadow-2xl hover:shadow-pastel-purple/20 overflow-hidden bg-white/60 backdrop-blur-xl border border-white/60 transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex-shrink-0">
                  <img className="h-48 w-full object-cover" src={blog.image} alt={blog.title} />
                </div>
                <div className="flex-1 p-6 flex flex-col justify-between">
                  <div className="flex-1">
                    <p className="text-sm font-bold text-pastel-purple">
                      {blog.tags.join(', ')}
                    </p>
                  ...
                  <div className="mt-6 flex items-center">
                    <div className="flex-shrink-0">
                      ...
                      <div className="h-10 w-10 rounded-full bg-pastel-pink/20 flex items-center justify-center text-pastel-purple font-bold text-lg border border-pastel-pink/30">
